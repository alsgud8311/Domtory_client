...
export default function ShortcutButtons() {
  return (
    // 모바일용 크기
    <div className="pl-4 pr-4 text-sm w-full max-w-[30rem]">
      ...
      {/* 중간 사이즈 크기
      <div className="hidden lg:hidden sm:flex w-1/2 justify-center p-4 box-border">
        <div className="w-20 flex justify-center flex-col gap-2 items-center">
          <a
            target="_blank"
            href="http://www.cbhs2.kr/main"
      ...
      {/* 데스크탑 사이즈 */}
      {/* <div className="w-16 lg:flex flex-col justify-center p-2 hidden absolute left-0">
        <div className="w-20 flex justify-center flex-col gap-2 items-center">
          <a
            target="_blank"
            href="http://www.cbhs2.kr/main"
